...
export const ui: Record<Locale, Record<string, string>> = {
  en: {
    ...
    supportedBy1: "School of Computing Science",
    supportedBy2: "& School of Medicine, Dentistry & Nursing",
    supportedBy3: "University of Glasgow",
    specialThanksLabel: "Special thanks",
    specialThanksName: "Ms Lim Li Peng",
    specialThanksBody: "Professional yoga instructor leading the demonstrations featured throughout Heal Yoga.",
